...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Jul 2022 pada 10.14
...
(556, 'Didi', '019ed8e839f7f34ef0968980475af0ca', 'Didi Khumaedi');
...
--
ALTER TABLE `pasien`
  MODIFY `id_pasien` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
