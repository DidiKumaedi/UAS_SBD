...
if (isset($_POST['submit']))
{
	...
	$sql		= 'INSERT INTO berobat2 (nama_pasien, nama_dokter, tgl_berobat, keluhan_pasien, hasil_diagnosa, penatalaksanaan)';
	$sql		.= "VALUE ('{$nama}', '{$dokter}', '{$tanggal}','{$keluhan}', '{$diagnosa}', '{$laksana}')";
